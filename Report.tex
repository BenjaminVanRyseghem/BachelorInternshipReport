...
\begin{itemize}
	...
	%	\item Walnut : based on Hazelnut, it should includes more classes
	%	\item Coconut : based on Walnut it should includes more classes
\end{itemize}
...
This project is composed by three different parts, the kernel collection, the kernel isolation and finally the image creation.
	...
	\section{Kernel Class Identification}\input{KernelCreation.tex}
